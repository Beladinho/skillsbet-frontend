...
function minimax(board, depth, alpha, beta, maximizing) {
  ...
  for (const col of validCols) {
    ...
    if (!res) continue;
    if (checkWin(res.newBoard, res.row, col, player)) {
      return { score: maximizing ? 1000000 + depth : -1000000 - depth, col };
    }
  ...
  return (
    <div style={{ textAlign: "center", marginTop: "20px", fontFamily: "'Rajdhani', 'Arial Narrow', sans-serif" }}>
            ...
            {row.map((cell, colIdx) => (
              <div
                ...
                style={{
                  ...
                  background: hoveredCol === colIdx && isHumanTurn ? "rgba(255,102,0,0.06)" : "transparent",
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: "36px", marginTop: "20px" }}>
        {[
          { color: P1_COLOR, name: playerId, label: "Vous" },
          { color: P2_COLOR, name: "BOT", label: DIFFICULTY_LABELS[difficulty] },
        ].map(({ color, name, label }) => (
